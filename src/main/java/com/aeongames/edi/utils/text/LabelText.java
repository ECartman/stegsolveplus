...
public class LabelText {
     ...
     * @param MinWidth
     */
    public static void SyncwrapLabelText(final JLabel label, final String text, int MinWidth) {
        final String finalstring = getTrimmedtoComponentsize(text, label,MinWidth);
        if (EventQueue.isDispatchThread()) {
            label.setText(finalstring);
        } else {
            try {
